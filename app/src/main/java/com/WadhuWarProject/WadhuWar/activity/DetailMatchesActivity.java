...
public class DetailMatchesActivity extends AppCompatActivity implements NetworkStateReceiver.NetworkStateReceiverListener, PopupMenu.OnMenuItemClickListener {

    int a11_height, a12_height, a21_height, a22_height, a23_height;

    private List<TabMyMatchesList.TabMyMatchesListData> profileList;
    ...
    ImageView close_btn,next_profile,back_profile;
    ...
    TextView name, age_height, lang_caste, job, address, about_txt, acc_id, profile_created_for, about_desc, not_see_txt,
            age_height_color, birthday_date,birthday_time, marital_status, address_lifestyle, job_lifestyle, diet, lang_status, caste_status,
...
//        setContentView(R.layout.activity_detail_maches);
        ...
        next_profile = findViewById(R.id.next_profile);
        ...
        String jsonList = intent.getStringExtra("profile_list");
        ...
        // Debug: Check if jsonList is null
        if (jsonList == null) {
            Toast.makeText(this, "Error: Profile list is empty", Toast.LENGTH_SHORT).show();
            finish(); // Close activity if data is missing
            return;
        }

        Type listType = new TypeToken<ArrayList<TabMyMatchesList.TabMyMatchesListData>>() {}.getType();
        profileList = new Gson().fromJson(jsonList, listType);

        // Debug: Check if profileList is null
        if (profileList == null || profileList.isEmpty()) {
            Toast.makeText(this, "Error: Failed to load profiles", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }

        TabMyMatchesList.TabMyMatchesListData currentProfile = profileList.get(currentPosition);


        next_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (currentPosition < profileList.size() - 1) {
                    currentPosition++;

                    // ✅ Update people_userid from profileList
                    people_userid = profileList.get(currentPosition).getId();

                    fetchProfileData();
                } else {
                    Toast.makeText(DetailMatchesActivity.this, "No more profiles!", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//        getSupportActionBar().setTitle("");
        ...
        user = SharedPrefManager.getInstance(DetailMatchesActivity.this).getUser();
        ...
        btn_block_report.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PopupMenu popup = new PopupMenu(DetailMatchesActivity.this, view);
                ...
                popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (item.getItemId() == R.id.report_profile) {
                            Intent i = new Intent(DetailMatchesActivity.this, ReasonForReportActivity.class);
    ...
    private void showConfirmationDialogBoxBlock() {
        AlertDialog.Builder builder = new AlertDialog.Builder(DetailMatchesActivity.this);
...
//                Toast.makeText(DetailMatchesActivity.this, "Please check internet connection!", Toast.LENGTH_SHORT).show();
...
//                                Toast.makeText(DetailMatchesActivity.this, addShortList.getResMsg(), Toast.LENGTH_SHORT).show();
//
...
//                        progressBar.dismiss();
//
//                        if (!isNetworkAvailable(DetailMatchesActivity.this)) {
//                            Toast.makeText(DetailMatchesActivity.this, "Please Check Internet Connection!", Toast.LENGTH_SHORT).show();
//
//                        } else {
//                            Toast.makeText(DetailMatchesActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
//
//                        }
//
//                    }
...
//                                Toast.makeText(DetailMatchesActivity.this, removeShortList.getResMsg(), Toast.LENGTH_SHORT).show();
//
//                                fetchProfileDataforShortlistUpdate();
//                            } else {
//                                Toast.makeText(DetailMatchesActivity.this, removeShortList.getResMsg(), Toast.LENGTH_SHORT).show();
...
//    }
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (itemId == R.id.add_to_shortlist) {
            handleShortlistAction(apiService, true);
            return true;

        } else if (itemId == R.id.remove_from_shortlist) {
            handleShortlistAction(apiService, false);
            return true;
    ...
    private void handleShortlistAction(Api apiService, boolean isAddToShortlist) {
        Call<InsertResponse> userResponse;
        String action = isAddToShortlist ? "add" : "remove";

        if (isAddToShortlist) {
            userResponse = apiService.shortListProfile(String.valueOf(user.getUser_id()), fetchProfile1.getUser_id());
        } else {
            userResponse = apiService.removeShortListProfile(String.valueOf(user.getUser_id()), fetchProfile1.getUser_id());
        }
        ...
        userResponse.enqueue(new Callback<InsertResponse>() {
            ...
            public void onResponse(Call<InsertResponse> call, Response<InsertResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if ("200".equals(result.getResid())) {
                        Toast.makeText(DetailMatchesActivity.this, result.getResMsg(), Toast.LENGTH_SHORT).show();
                        fetchProfileDataforShortlistUpdate();
                    } else {
                        Toast.makeText(DetailMatchesActivity.this, result.getResMsg(), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(DetailMatchesActivity.this, "Error in response!", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onFailure(Call<InsertResponse> call, Throwable t) {
                progressBar.dismiss();
                System.out.println("Error during " + action + " to shortlist: " + t.toString());
...
//                    Toast.makeText(DetailMatchesActivity.this,"Connect Now Click ",Toast.LENGTH_SHORT).show();
        ...
        seeAllAddressLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(DetailMatchesActivity.this, AddressInDetailActivity.class);
        ...
        seeAllfamilyLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DetailMatchesActivity.this, FamilyInDetailActivity.class);
                i.putExtra("userdata", fetchProfileofUsers);
                startActivity(i);
            }
        });
        ...
        seeAllPrefLL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(DetailMatchesActivity.this, PartnerPrefInDetailActivity.class);
                i.putExtra("userdata", fetchProfileofUsers);
                startActivity(i);
            }
        });
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (fetchProfile.getResid().equals("200")) {
                            ...
                            like_count.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View view) {
                                    Intent i = new Intent(DetailMatchesActivity.this, LikeShowActivity.class);
                            ...
                            chat_btn1.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    if (fetchProfileLoginUser.getPremium().equals("1")) {
                                        Intent i = new Intent(DetailMatchesActivity.this, ChatActivity.class);
                            ...
                            call_btn1.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    if (fetchProfileLoginUser.getPremium().equals("1") && fetchProfile.getIs_connected().equals("1")) {
                                        ...
                                        if (ContextCompat.checkSelfPermission(DetailMatchesActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {

                                            ActivityCompat.requestPermissions((Activity) DetailMatchesActivity.this, new String[]{Manifest.permission.CALL_PHONE},
                            ...
                            if (fetchProfile.getIs_connected().equals("1")) {
                                ...
                                if (fetchProfileLoginUser.getPremium().equals("1")) {
                                    ...
                                    upgrade_txt.setOnClickListener(new View.OnClickListener() {
                                        @Override
                                        public void onClick(View view) {
                                            Intent i = new Intent(DetailMatchesActivity.this, PremiumActivity.class);
                                            startActivity(i);
                                        }
                                    });
                                    chat_btn.setOnClickListener(new View.OnClickListener() {
                                ...
                                view_all_detail.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if (fetchProfileLoginUser.getView_count().equals(fetchProfileLoginUser.getCount())) {
                                            ...
                                            final Dialog dialog = new Dialog(DetailMatchesActivity.this);
...
//                                conversation_background_familyLL.setVisibility(View.VISIBLE);
                                                        ...
                                                        Toast.makeText(DetailMatchesActivity.this, viewCountRespo.getResMsg(), Toast.LENGTH_SHORT);
                                                    }
                                ...
                                top_cv.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        if (verified_txtLL.getVisibility() == View.VISIBLE) {
                                            ...
                                            Intent i = new Intent(DetailMatchesActivity.this, ImagesActivity.class);
                                            if (fetchProfile.getImages().size() != 0)
...
//                    if (fetchProfileLoginUser.getPremium().equals("1") || fetchProfile.getIs_connected().equals("1")) {
                            if (fetchProfileLoginUser.getPremium().equals("1")) {
                                ...
                                if (fetchProfile.getBirth_time() != null && !fetchProfile.getBirth_time().equals("Not Specified")) {
                                    ...
                                    birthday_time.setText("Born time " + fetchProfile.getBirth_time());           // change by tanmay for birth time 27-1-2025
                                } else {
                                    birthday_date.setText("Born on " + fetchProfile.getDob());
                                ...
                                birthday_time.setText("Born time **.**");
                                birthday_lock.setVisibility(View.VISIBLE);
...
//                System.out.println("like respo==========" + new Gson().toJson(likeProfileResponse));
                ...
                if (response.isSuccessful()) {
                    ...
                    if (likeProfileResponse.getResid().equals("200")) {
                        ...
                        Toast.makeText(DetailMatchesActivity.this, connect_response.getResMsg(), Toast.LENGTH_SHORT).show();
                    }
                }
...
//                    Toast.makeText(DetailMatchesActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void fetchLoginProfileData() {
        ...
        progressBar = ProgressDialog.show(DetailMatchesActivity.this, "", "Please Wait...");
            ...
            public void onResponse(Call<FetchProfile> call, Response<FetchProfile> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    option_LL.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            PopupMenu popup = new PopupMenu(DetailMatchesActivity.this, view);
                            popup.setOnMenuItemClickListener(DetailMatchesActivity.this);
...
//                    Toast.makeText(DetailMatchesActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void openBottomSheet(FetchProfile fetchProfile) {
        ...
        mBottomSheetDialog = new BottomSheetDialog(DetailMatchesActivity.this);
            ...
            public void onResponse(Call<InsertResponse> call, Response<InsertResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (acceptResponse.getResid().equals("200")) {
                        ...
                        Toast.makeText(DetailMatchesActivity.this, "Request Accept.", Toast.LENGTH_SHORT).show();

                    } else {
                        Toast.makeText(DetailMatchesActivity.this, acceptResponse.getResMsg(), Toast.LENGTH_SHORT).show();
                    }
                }
            }
            ...
            public void onResponse(Call<CommonResponse> call, Response<CommonResponse> response) {
                ...
                if (response.isSuccessful()) {
                    if (commonResponse.getResid() == 200) {
                        finish();
                        Toast.makeText(DetailMatchesActivity.this, "Block this user", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(DetailMatchesActivity.this, commonResponse.getResMsg(), Toast.LENGTH_SHORT).show();
                    }
                }
