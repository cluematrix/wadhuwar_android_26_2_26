                            ...
                            if (data != null) {
                                ...
                                if (clipData != null) {
                                    ...
                                    for (int i = 0; i < count; i++) {
                                        ...
                                        String n = getPathFromURI(imageUri);
                                        imageArry.add(new Image(n));
                                        adapter11.notifyDataSetChanged();
                                    }
                                } else {
...
//            final Uri contentUri = ContentUris.withAppendedId(Uri.parse("content://downloads/public_downloads"), Long.valueOf(id));
            ...
            imagePath = getDataColumn(AddPhotosActivity.this, contentUri, null, null);
            ...
            return getDataColumn(AddPhotosActivity.this, contentUri, selection, selectionArgs);
            ...
            return getDataColumn(AddPhotosActivity.this, uri, null, null);
        }
        // File
