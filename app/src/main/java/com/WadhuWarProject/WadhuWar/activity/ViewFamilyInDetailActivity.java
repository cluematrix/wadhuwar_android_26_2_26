...
public class ViewFamilyInDetailActivity extends AppCompatActivity implements NetworkStateReceiver.NetworkStateReceiverListener{
    Toolbar toolbar;
    UserData user;
    int pref_count;
...
//        getWindow(). setFlags(WindowManager.LayoutParams. FLAG_SECURE, WindowManager.LayoutParams. FLAG_SECURE);
        ...
        user = SharedPrefManager.getInstance(ViewFamilyInDetailActivity.this).getUser();
