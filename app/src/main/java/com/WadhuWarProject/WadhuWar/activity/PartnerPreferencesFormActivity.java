...
public class PartnerPreferencesFormActivity extends AppCompatActivity implements
    ...
    TextView education_type_txtv, district_txtv;
    ...
    Spinner marital_status_spinner, colorcomplex_spinner, height_spinner, height_spinner_to,religion_spinner, caste_spinner, sub_caste_spinner, highest_education_spinner, lifestyle_spinner,
            ...
            education_type_spinner, occupation_type_spinner, occupation_spinner, salary_spinner, current_state_spinner, current_district_spinner, current_country_spinner;
    ...
    String marital_str, colorcomplex_str, height_str, height_to_str, religion_list_str, caste_list_str, sub_caste_str, education_list_str,
            lifestyle_str, dietray_str, ageTo_list_str, agefrom_list_str, sampraday_list_str, education_type_list_str;
    String maritalstatus_id, colorcomplex_id, height_id, religion_id, caste_id, subcaste_id, dietray_id,
            age_id, sampraday_id, education_id, lifestyle_id, education_type_id, salary_str, state_list_str = "", district_str = "", country_list_str = "", district_id, state_id, country_id;
    ...
    String occupation_list_str, occupation_type_list_str, occupation_type_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_partner_preferences_form);
...
//                            System.out.println("list  name>>>>>>>>>>>>>>>" + packages.get(i).getName());
                ...
                submitData(education_type_pckg_list, maritalstatus_id, colorcomplex_id, height_str, height_to_str, religion_id, caste_id, subcaste_id, agefrom_list_str, ageTo_list_str, pckg_list, lifestyle_id,
                        dietray_id, _expectation, sampraday_id, user_id, occupation_pckg_list, occupation_type_pckg_list, salary_str, country_id, state_id, district_pckg_list);
...
//                swipeRefreshLayout.setRefreshing(false);
    ...
    public void networkUnavailable() {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(PartnerPreferencesFormActivity.this, "Please check internet connection!", Toast.LENGTH_SHORT).show();
    ...
    public void submitData(String education_type_id, String maritalstatus_id, String colorcomplex_id, String height_from_str, String height_to_str, String religion_id, String caste_id,
            ...
            , String salary_str, String country_id, String state_id, String district_id) {

        progressBar = ProgressDialog.show(PartnerPreferencesFormActivity.this, "", "Please Wait...");
        ...
        Call<InsertResponse> userResponse = apiService.insertStep5(marital_status_pckg_list, color_complexion_pckg_list, height_from_str, height_to_str, religion_id,
                ...
                sampraday_id, user_id, education_type_id, occupation_type_id, occupation_id, salary_str, country_id, state_id, district_pckg_list,"");
            ...
            public void onResponse(Call<InsertResponse> call, Response<InsertResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (success.equals("200")) {
                        Toast.makeText(PartnerPreferencesFormActivity.this, insertResponse.getResMsg(), Toast.LENGTH_SHORT).show();
//                        Intent i = new Intent(PartnerPreferencesFormActivity.this, AccomodationDetailActivity.class);
                        Intent i = new Intent(PartnerPreferencesFormActivity.this, InsertStep7Activity.class);
            ...
            public void onFailure(Call<InsertResponse> call, Throwable t) {
                ...
                if (!isNetworkAvailable(PartnerPreferencesFormActivity.this)) {

                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Check Internet Connection!", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Try Again!", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void sampraday_spinner_data(List<SampradayList.SampradayListData> sampradayListData) {
        ...
        adapter_sampraday = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, sampraday_list);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void ageFrom_spinner_data(List<AgeList.AgeListData> ageListDataFrom) {
        ...
        adapter_ageFrom = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, ageFrom_list);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void ageTo_spinner_data(List<AgeList.AgeListData> ageListDataTo) {
        ...
        adapter_ageTo = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, ageTo_list);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void dietary_spinner_data(List<DietaryList.DietaryListData> dietaryListData) {
        ...
        adapter_dietray = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, dietray_list);
        ...
        dietary_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (!dietray_str.equals("Select Dietary")) {
                    ...
                    dietary_txtv = new TextView(PartnerPreferencesFormActivity.this);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void lifestyle_spinner_data(List<LifeSettingList.LifeSettingListData> lifeSettingListData) {
        ...
        lifestyle_adapter = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, lifestyle_list);
        ...
        lifestyle_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (!lifestyle_str.equals("Select LifeStyle")) {
                    ...
                    lifestyle_txtv = new TextView(PartnerPreferencesFormActivity.this);
...
//            }
//        }
//        adapter_education_type = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, education_type_list);
//
...
//
//
//                    education_type_txtv   = new TextView(PartnerPreferencesFormActivity.this);
...
//            }
//        }
//        adapter_education = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, education_list);
//
...
//
//
//                            textView3 = new TextView(PartnerPreferencesFormActivity.this);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void religion_spinner_data(List<ReligionList.ReligionListData> religionListData) {
        ...
        adapter_religion = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, religion_list);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void caste_spinner_data(List<CasteList.CasteListData> casteListData) {
        ...
        caste_adapter = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, caste_list);
    ...
    public void subCaste_spinner_data(List<SubCasteList> subCasteLists) {
        ...
        sub_caste_adapter = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, sub_caste_list);
        ...
        sub_caste_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (!sub_caste_str.equals("Select Sub-Caste")) {
                    ...
                    subcaste_txtv = new TextView(PartnerPreferencesFormActivity.this);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void colorcomplex_spinner_data(List<ColorcomplexList.ColorcomplexListData> colorcomplexListData) {
        ...
        colorcomplex_adapter = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, colorcomplex_list);
        ...
        colorcomplex_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (!colorcomplex_str.equals("Select Color-Complex")) {
                    ...
                    color_complexion_txtv = new TextView(PartnerPreferencesFormActivity.this);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void height_spinner_data_from(List<HeightList.HeightListData> heightListData) {
        ...
        height_adapter = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, height_list_from);
    ...
    public void height_spinner_data_to(List<HeightList.HeightListData> heightListData) {
        ...
        height_adapter = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, height_list_to);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void marital_spinner_data(List<MaritalSettingList.MaritalSettingListData> maritalSettingListData) {
        ...
        adapter_marital = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, marital_list);
        ...
        marital_status_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (!marital_str.equals("Select Marital Status")) {
                    ...
                    marital_status_txtv = new TextView(PartnerPreferencesFormActivity.this);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        PartnerPreferencesFormActivity.super.onBackPressed();
                        finish();
                    }
...
//
//
//                        textView1_type = new TextView(PartnerPreferencesFormActivity.this);
...
//
//
//                        textView1 = new TextView(PartnerPreferencesFormActivity.this);
                    ...
                    if (education_pck_array.size() != 0) {
                        for (int h = 0; h < education_pck_array.size(); h++) {
                            ...
                            if (!education_list_str.equals("Select Education") && !education_pck_array.contains(education_list_str.trim())) {
                                ...
                                textView2 = new TextView(PartnerPreferencesFormActivity.this);
...
//                                education_pck_array.remove(charSequence);
                    ...
                    Toast.makeText(PartnerPreferencesFormActivity.this, "Already Added!!!", Toast.LENGTH_SHORT).show();
                }
                /*new cond*/
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void occupation_type_spinner_data(List<OccupationType.OccupationTypeData> OccupationTypeData) {
        ...
        adapter_occupation_type = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, occupation_type_list);
...
//                hideShowOccupation();
                ...
                if (!occupation_type_list_str.equals("Select Occupation Type")) {
                    ...
                    occupation_type_txtv = new TextView(PartnerPreferencesFormActivity.this);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void occupation_spinner_data(List<OccupationList.OccupationListData> occupationListData) {
        ...
        adapter_occupation = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, occupation_list);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void salary_spinner_data(ArrayList<SalaryList.SalaryListData> salaryListData) {
        ...
        salary_adapter = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, salary_list);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void country_spinner_data(List<CountryList.CountryListData> countryListData) {
        ...
        adapter_country = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, country_list);
    ...
    public void state_spinner_data(List<StateList> stateLists) {
        ...
        adapter_state = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, state_list);
...
//                    Toast.makeText(PartnerPreferencesFormActivity.this, "Please Refresh!", Toast.LENGTH_SHORT).show();
    ...
    public void district_spinner_data(List<DistrictList.DistrictListData> districtListData) {
        ...
        district_adapter = new ArrayAdapter<String>(PartnerPreferencesFormActivity.this, R.layout.simple_spinner_item, district_list);
        ...
        current_district_spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, final int position, long id) {
                ...
                if (!district_str.equals("Select District")) {
                    ...
                    district_txtv = new TextView(PartnerPreferencesFormActivity.this);
