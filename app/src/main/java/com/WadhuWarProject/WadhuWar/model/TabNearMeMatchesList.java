...
public class TabNearMeMatchesList {


    @SerializedName("MatchesTabNearList")
    @Expose
    public ArrayList<MatchesTabNearListData> matchesTabNearList;
    ...
    public ArrayList<MatchesTabNearListData> getMatchesTabNearList() {
        return matchesTabNearList;
    }

    public void setMatchesTabNearList(ArrayList<MatchesTabNearListData> matchesTabNearList) {
    ...
    public static class MatchesTabNearListData {
