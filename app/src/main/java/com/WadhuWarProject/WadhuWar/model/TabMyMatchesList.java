...
public class TabMyMatchesList {


    @SerializedName("TabMyMatchesList")
    @Expose
    public ArrayList<TabMyMatchesListData> TabMyMatchesList;
    ...
    public ArrayList<TabMyMatchesListData> getTabMyMatchesList() {
        return TabMyMatchesList;
    }

    public void setTabMyMatchesList(ArrayList<TabMyMatchesListData> tabMyMatchesList) {
    ...
    public static class TabMyMatchesListData {
