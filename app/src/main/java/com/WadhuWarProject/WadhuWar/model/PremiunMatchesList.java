...
public class PremiunMatchesList {
    ...
    @SerializedName("PremiumMatchesList")
    @Expose
    public ArrayList<PremiunMatchesListData> PremiumMatchesList;
    ...
    public ArrayList<PremiunMatchesListData> getPremiumMatchesList() {
        return PremiumMatchesList;
    }

    public void setPremiumMatchesList(ArrayList<PremiunMatchesListData> premiumMatchesList) {
        PremiumMatchesList = premiumMatchesList;
    }
    ...
    public static class PremiunMatchesListData {
