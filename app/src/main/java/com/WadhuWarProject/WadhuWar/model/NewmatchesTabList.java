...
public class NewmatchesTabList implements Serializable {


    @SerializedName("NewmatchesTabList")
    @Expose
    public ArrayList<NewmatchesTabListData> NewmatchesList;
    ...
    public ArrayList<NewmatchesTabListData> getNewmatchesList() {
        return NewmatchesList;
    }

    public void setNewmatchesList(ArrayList<NewmatchesTabListData> newmatchesList) {
    ...
    public static class NewmatchesTabListData {
