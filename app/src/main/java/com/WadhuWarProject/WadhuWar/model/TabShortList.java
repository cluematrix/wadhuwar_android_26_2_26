...
public class TabShortList {


    @SerializedName("MatchesTabShortList")
    @Expose
    public ArrayList<MatchesTabShortListData> MatchesTabShortList;
    ...
    public ArrayList<MatchesTabShortListData> getMatchesTabShortList() {
        return MatchesTabShortList;
    }

    public void setMatchesTabShortList(ArrayList<MatchesTabShortListData> matchesTabShortList) {
        MatchesTabShortList = matchesTabShortList;
    }
    ...
    public class MatchesTabShortListData {
