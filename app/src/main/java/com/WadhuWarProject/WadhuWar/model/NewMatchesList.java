...
public class NewMatchesList {
    ...
    @SerializedName("NewmatchesList")
    @Expose
    public ArrayList<NewmatchesListData> NewmatchesList;
    ...
    public ArrayList<NewmatchesListData> getNewmatchesList() {
        return NewmatchesList;
    }

    public void setNewmatchesList(ArrayList<NewmatchesListData> newmatchesList) {
    ...
    public static class NewmatchesListData {
