...
public class RecentVisitorMatchesList {
    ...
    @Expose
    String total_pages;
    @SerializedName("RecentVisitorsList")
    @Expose
    public ArrayList<RecentVisitorsListmatchesListData> recentVisitorsList;
    ...
    public ArrayList<RecentVisitorsListmatchesListData> getRecentVisitorsList() {
        return recentVisitorsList;
    }

    public void setRecentVisitorsList(ArrayList<RecentVisitorsListmatchesListData> recentVisitorsList) {
        this.recentVisitorsList = recentVisitorsList;
    }
    ...
    public static class RecentVisitorsListmatchesListData {
