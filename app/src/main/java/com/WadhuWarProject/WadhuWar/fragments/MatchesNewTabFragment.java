...
public class MatchesNewTabFragment extends Fragment  implements  NetworkStateReceiver.NetworkStateReceiverListener{
    ...
    public static MatchesNewTabFragment newInstance() {
        MatchesNewTabFragment fragment = new MatchesNewTabFragment();
        return fragment;
    }


    public MatchesNewTabFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =inflater.inflate(R.layout.fragment_matches_new_tab, container, false);
...
//                        just_joind_cv.setVisibility(View.VISIBLE);
    ...
    public void loadFirstPage(){
        ...
        Api apiService = RetrofitClient.getApiService();
        Call<NewmatchesTabList> userResponse = apiService.newmatchesTabList("1",String.valueOf(user.getUser_id()),"10","1");
...
//                        System.out.println("resp 123123.......>>>" + new Gson().toJson(response.body()));
    ...
    public void loadNextPage(int pos){
        ...
        Api apiService = RetrofitClient.getApiService();
        Call<NewmatchesTabList> userResponse = apiService.newmatchesTabList("1",String.valueOf(user.getUser_id()),"10", String.valueOf(pos));
        userResponse.enqueue(new Callback<NewmatchesTabList>() {
