...
public class TabNearMeMatchesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TabNearMeMatchesAdapter(Context context) {
 ...
 */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case LOADING:
                ...
                viewHolder = new TabNearMeMatchesAdapter.LoadingVH(v2);
                break;
        }
        return viewHolder;
    }
    ...
    private RecyclerView.ViewHolder getViewHolder(ViewGroup parent, LayoutInflater inflater) {
        ...
        viewHolder = new TabNearMeMatchesAdapter.ProductViewHolder(v1);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, final int position) {        //getting the product of the specified position
        ...
        switch (getItemViewType(position)) {
            ...
            case ITEM:
                final TabNearMeMatchesAdapter.ProductViewHolder holder = (TabNearMeMatchesAdapter.ProductViewHolder) holder1;
...
//                Do nothing
                ...
                final TabNearMeMatchesAdapter.LoadingVH holder2 = (TabNearMeMatchesAdapter.LoadingVH) holder1;
