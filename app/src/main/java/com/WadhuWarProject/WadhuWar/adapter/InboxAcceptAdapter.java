...
public class InboxAcceptAdapter extends   RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ArrayList<MemberList.MemberListData> memberListData ;
    Context context;
    ...
    public InboxAcceptAdapter(Context context, String login_user_id, String loginUserPremiumCheck ) {
        ...
        switch (getItemViewType(position)) {
            ...
            case ITEM:
                ...
                if(memberListData!=null &&  memberListData.size()!=0) {
                    ...
                    System.out.println("member id 123===========" + memberListData.get(position).getId());
                    ...
                    if(!memberListData.get(position).getDistrict().equals("Not Specified") &&
                        ...
                        if(!memberListData.get(position).getEducation_name().equals("Not Specified")){
                            holder.t2.setText(memberListData.get(position).getDistrict()+", "+memberListData.get(position).getState() +", "+memberListData.get(position).getEducation_name());
                        ...
                        if(!memberListData.get(position).getEducation_name().equals("Not Specified")){
                            holder.t2.setText(memberListData.get(position).getDistrict() +", "+memberListData.get(position).getEducation_name());
                        ...
                        if(!memberListData.get(position).getEducation_name().equals("Not Specified")){
                            holder.t2.setText(memberListData.get(position).getState()+", "+memberListData.get(position).getEducation_name());
                            ...
                            holder.t2.setText(memberListData.get(position).getState() );
                                ...
                                memberListData.get(position).getState().equals("Not Specified") && memberListData.get(position).getEducation_name().equals("Not Specified")) {
                    ...
                    holder.whatapp_btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if(loginUserPremiumCheck.equals("1") && memberListData.get(position).getIs_connected().equals("1")){

                                String whatapp_no = memberListData.get(position).getWhatsapp();
                            ...
                            }else if(!memberListData.get(position).getIs_connected().equals("1")){
                    ...
                    holder.call_btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            String mo_num = memberListData.get(position).getMobile_no();
                    ...
                    holder.chat_btn.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            i.putExtra("receiver_id",memberListData.get(position).getId());
                            i.putExtra("receiver_name",memberListData.get(position).getName());
                            i.putExtra("receiver_image",memberListData.get(position).getImage());
                            context.startActivity(i);
...
//                Do nothing
    ...
    */
    ...
    protected  class ProductViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout whatapp_btn,call_btn,chat_btn;
    ...
    public  void  openBottomSheet(int position){
        ...
        if(memberListData.get(position).getImage()!=null) {
            if (!memberListData.get(position).getImage().equals("")) {
                Glide.with(context.getApplicationContext()).load(memberListData.get(position).getImage()).into(img_box);
            }else{
...
//        Glide.with(context).load(memberListData.get(position).getImage()).into(img_box);
...
//                System.out.println("res reject******" + new Gson().toJson(rejectResponse));
                ...
                if (response.isSuccessful()) {
                    ...
                    if(rejectResponse.getResid().equals("200")){
                        ...
                        System.out.println("status check decline============" + memberListData.size());
                        if(memberListData.size()>0){
