...
public class SearchResultsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ArrayList<SearchData.SearchDataList> searchDataLists ;
    Context context;
...
//    SharedPrefManager sharedPrefManager;
    ...
    public ArrayList<SearchData.SearchDataList> getSearchDataList() {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder1, final int position)   {        //getting the product of the specified position
        ...
        switch (getItemViewType(position)) {
            ...
            case ITEM:
                ...
                if(searchDataLists!=null && searchDataLists.size()!=0) {

                    holder.name.setText(searchDataLists.get(position).getName());


                    if (!searchDataLists.get(position).getAge().contentEquals("Not Specified") &&
                            !searchDataLists.get(position).getHeight().contentEquals("Not Specified")) {
                        holder.age_height.setText(String.format("%syrs, %s,", searchDataLists.get(position).getAge(), searchDataLists.get(position).getHeight()));

                    } else if (!searchDataLists.get(position).getAge().contentEquals("Not Specified") &&
                            searchDataLists.get(position).getHeight().contentEquals("Not Specified")) {
                        holder.age_height.setText(searchDataLists.get(position).getAge()+" yrs");

                    } else if (searchDataLists.get(position).getAge().contentEquals("Not Specified") &&
                            !searchDataLists.get(position).getHeight().contentEquals("Not Specified")) {
                        holder.age_height.setText(searchDataLists.get(position).getHeight());
                    ...
                    if (!searchDataLists.get(position).getOccupation().contentEquals("Not Specified")) {
                        holder.job.setText(searchDataLists.get(position).getOccupation());
                    ...
                    if (!searchDataLists.get(position).getMothertounge().contentEquals("Not Specified") &&
                            !searchDataLists.get(position).getCaste().contentEquals("Not Specified")) {
                        holder.lang.setText(String.format("%s,%s", searchDataLists.get(position).getMothertounge(), searchDataLists.get(position).getCaste()));

                    } else if (!searchDataLists.get(position).getMothertounge().contentEquals("Not Specified") &&
                            searchDataLists.get(position).getCaste().contentEquals("Not Specified")) {
                        holder.lang.setText(searchDataLists.get(position).getMothertounge());

                    } else if (searchDataLists.get(position).getMothertounge().contentEquals("Not Specified") &&
                            !searchDataLists.get(position).getCaste().contentEquals("Not Specified")) {
                        holder.lang.setText(searchDataLists.get(position).getCaste());
                    ...
                    System.out.println("premiunMatchesListData.get(position).getDistrict()---" + searchDataLists.get(position).getDistrict());
                    System.out.println("premiunMatchesListData.get(position).getState()---" + searchDataLists.get(position).getState());

                    if (!searchDataLists.get(position).getDistrict().contentEquals("Not Specified") &&
                            !searchDataLists.get(position).getState().contentEquals("Not Specified")) {
                        holder.address.setText(String.format("%s, %s", searchDataLists.get(position).getDistrict(), searchDataLists.get(position).getState()));
                        holder.address_dot.setVisibility(View.VISIBLE);

                    } else if (!searchDataLists.get(position).getDistrict().contentEquals("Not Specified") &&
                            searchDataLists.get(position).getState().contentEquals("Not Specified")) {
                        holder.address.setText(searchDataLists.get(position).getDistrict());
                        holder.address_dot.setVisibility(View.VISIBLE);

                    } else if (searchDataLists.get(position).getDistrict().contentEquals("Not Specified") &&
                            !searchDataLists.get(position).getState().contentEquals("Not Specified")) {
                        holder.address.setText(searchDataLists.get(position).getState());
                        holder.address_dot.setVisibility(View.VISIBLE);
...
*/
                    ...
                    if (searchDataLists.get(position).getImage() != null) {
                        if (searchDataLists.get(position).getImage().equals("")) {
                            ...
                            if(searchDataLists.get(position).getGender().equals("Female")){
                            ...
                            Glide.with(context.getApplicationContext()).load(searchDataLists.get(position).getImage()).into(holder.img);
                    ...
                    if (searchDataLists.get(position).getIsDelete().equals("2")) {
                        Glide.with(context.getApplicationContext()).
                                load(searchDataLists.get(position).getImage())
                            ...
                            if (SharedPrefManager.getInstance(context).getString().equals("0")) {
                                ...
                                if (user.getPremium().equals("1")) {
                                    ...
                                    if (searchDataLists.get(position).getIsDelete().equals("2")) {
                                        ...
                                        callSaveHistoryApi(String.valueOf(login_user), searchDataLists.get(position).getId(), position);
                                    }
...
//                    }
    ...
    */
    ...
    public void add(SearchData.SearchDataList mc) {
        searchDataLists.add(mc);
        notifyItemInserted(searchDataLists.size() - 1);
    }


    public void addAll(ArrayList<SearchData.SearchDataList> mcList) {
        for (SearchData.SearchDataList mc : mcList) {
            add(mc);
    ...
    public void remove(SearchData.SearchDataList p) {
        int position = searchDataLists.indexOf(p);
        if (position > -1) {
    ...
    public void addLoadingFooter() {
        ...
        add(new SearchData.SearchDataList());
    }
    ...
    public void removeLoadingFooter() {
        ...
        int position = searchDataLists.size() - 1;
    ...
    public SearchData.SearchDataList getItem(int position) {
    ...
    */
    ...
    public int getItemViewType(int position) {
        return (position == searchDataLists.size() - 1 && isLoadingAdded) ? LOADING : ITEM;
    }
